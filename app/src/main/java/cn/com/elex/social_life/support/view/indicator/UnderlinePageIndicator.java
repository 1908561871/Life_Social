...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, cn.com.elex.social_life.R.attr.vpiUnderlinePageIndicatorStyle);
    }
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final boolean defaultFades = res.getBoolean(cn.com.elex.social_life.R.bool.default_underline_indicator_fades);
        final int defaultFadeDelay = res.getInteger(R.integer.default_underline_indicator_fade_delay);
        final int defaultFadeLength = res.getInteger(R.integer.default_underline_indicator_fade_length);
        final int defaultSelectedColor = res.getColor(cn.com.elex.social_life.R.color.default_underline_indicator_selected_color);
